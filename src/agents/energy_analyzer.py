...
class EnergyAnalyzer:
    ...
    def _analyze_consumption(self, data: Dict) -> Dict:
        ...
        daily_std = statistics.stdev(daily_consumptions) if len(daily_consumptions) > 1 else 0
        ...
        for d in daily_data:
            ...
            if consumption < lower_bound:
                ...
                anomalies.append({
                    ...
                    'consumption': consumption,
                    'type': 'high',
                    'severity': 'critical' if consumption > upper_bound * 1.5 else 'warning',
    ...
    def _generate_recommendations(self, analysis: Dict) -> List[Dict]:
        ...
        if anomalies['anomaly_count'] > 0:
            critical_anomalies = [
                a for a in anomalies['anomalies_found']
