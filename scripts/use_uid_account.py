...
def use_uid_to_get_devices(uid):
    ...
    for endpoint in endpoints:
        ...
        if try_endpoint_with_token(endpoint, access_token, client_id, client_secret, device_id):
            return True
    ...
    return try_device_endpoint_with_token(device_id, access_token, client_id, client_secret)
...
def try_endpoint_with_token(endpoint, access_token, client_id, client_secret, device_id):
